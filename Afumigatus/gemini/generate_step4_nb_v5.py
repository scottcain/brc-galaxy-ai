...
code_lines = [
    ...
    "    f.write(\"##source=JupyterLite_Step4_Iteration4\\n\")",
...
markdown_content = """# Step 4: Identifying Resistant-Specific SNPs (Iteration 4)
...
with open('resistant_specific_snps_v5_final.ipynb', 'w') as f:
    nbf.write(nb, f)

print("Created updated notebook: resistant_specific_snps_v5_final.ipynb")
